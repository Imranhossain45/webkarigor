                    ...
                    <div class="header-left">
                        <div class="header-dropdown">
                            ...
                            <div class="header-menu">
                                <ul>
                                    <li><a href="#"><i class="fa-solid fa-angle-down"></i>ENG</a>
                                    </li>
                                    <li><a href="#"><i class="fa-solid fa-angle-down"></i>FRA</a></li>
                                </ul>
                            </div>
                            <!-- End .header-menu -->
                        </div>
     ...
     <div class="container">
       <div class="header-left">
         ...
         <a href="demo21.html" class="logo">
           ...
           <img src="{{ asset('frontend/img/logo.png') }}" alt="Porto Logo" class="sticky-logo">
         </a>
         <span class="header_cat_bar rad_5"><i class="fa-solid fa-bars"></i></span>
